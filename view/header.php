...
<header>
		...
		<div id="menu-mobile-mask" class="d-xl-none"></div>
		...
		<div id="menu-mobile" class="d-xl-none">
			...
			<div class="bar-close">
				<button type="btn" class="btn btn-close"><i class="fas fa-times"></i></button>
			</div>
		...
		<div class="header-black">
			...
			<input type="search" id="input-search-mobile" placeholder="search..." class="d-xl-none">
